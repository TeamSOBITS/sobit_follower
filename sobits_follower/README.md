...
- SOBIT EDUを用いた人追従走行
- path：`sobits_follower/launch/sobit_edu/sobit_edu_follower_me.launch`
```python
$ roslaunch sobits_follower sobit_edu_follower_me.launch rviz:=false rqt_reconfigure:=false use_rotate:=true use_smoother:=true
# 引数
...
- path：`sobits_follower/launch/sobit_edu/sobit_edu_follower_me_id.launch`
```python
$ roslaunch sobits_follower sobit_edu_follower_me_id.launch rviz:=false rqt_reconfigure:=false use_rotate:=true use_smoother:=true
# 引数
# rviz : Rvizを起動するか(bool)
# rqt_reconfigure : rqt_reconfigureを起動するか(bool)
# use_rotate : SensorRotatorを起動するか(bool)
...
- SOBIT PROを用いた人追従走行
- path：`sobits_follower/launch/sobit_pro/sobit_pro_follower_me.launch`
```python
$ roslaunch sobits_follower sobit_pro_follower_me.launch rviz:=false rqt_reconfigure:=false use_rotate:=true use_smoother:=true
# 引数
# rviz : Rvizを起動するか(bool)
# rqt_reconfigure : rqt_reconfigureを起動するか(bool)
# use_rotate : SensorRotatorを起動するか(bool)
...
- path：`sobits_follower/launch/sobit_pro/sobit_pro_follower_me_id.launch`
```python
$ roslaunch sobits_follower sobit_pro_follower_me_id.launch rviz:=false rqt_reconfigure:=false use_rotate:=true use_smoother:=true
# 引数
# rviz : Rvizを起動するか(bool)
# rqt_reconfigure : rqt_reconfigureを起動するか(bool)
# use_rotate : SensorRotatorを起動するか(bool)
...
### [sobits_follower.launch.py](launch/sobits_follower.launch.py) (ROS2)
- ROS2用の統合Launch
- path：`sobits_follower/launch/sobits_follower.launch.py`
```bash
$ ros2 launch sobits_follower sobits_follower.launch.py robot_type:=hsrb
# 引数
...
- [ssd_param.yaml](param/ssd_param.yaml)
    ...
    - path：`sobits_follower/param/ssd_param.launch.xml`

### dr_spaam_ros.launch.xml
- #### [dr_spaam_ros.launch.xml](launch/include/dr_spaam_ros.launch.xml)
  - 2D LiDARベースの人物検出器
  - path：`sobits_follower/launch/include/dr_spaam_ros.launch.xml`
...
- [dr_spaam_param.yaml](param/dr_spaam_param.yaml)
    ...
    - path：`sobits_follower/param/dr_spaam_param.launch.xml`
...
- #### [sobit_pro_person_following_control.launch.xml](launch/include/sobit_pro/sobit_pro_person_following_control.launch.xml)
  ...
  - path：`sobits_follower/launch/include/person_following_control.launch.xml`
...
- [following_control_param.yaml](param/following_control_param.yaml)
    - 走行制御に関するパラメータ
    - path：`sobits_follower/param/following_control_param.launch.xml`
- [velocity_smoother_param.yaml](param/velocity_smoother_param.yaml)
    - 速度平滑化に関するパラメータ
    - path：`sobits_follower/param/velocity_smoother_param.launch.xml`
