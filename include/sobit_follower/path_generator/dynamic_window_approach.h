...
namespace PathPlan {
	...
	private :
		...
		sobit_follower::FollowPosition fp_;
	...
	public :
		...
		bool generatePath2Target ( const geometry_msgs::Twist& curt_vel, const sobit_follower::FollowPositionConstPtr &fp, geometry_msgs::Twist* output_path );
	};
}
