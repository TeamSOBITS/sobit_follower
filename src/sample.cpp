...
public:
	...
	kalman_filter_class(){
		...
		this->spawn_srv_ = nh.advertiseService("spawn", &kalman_filter_class::spawnCallback, this);

	}//public

~kalman_filter_class(){}

bool spawnCallback(turtlesim::Spawn::Request& req, turtlesim::Spawn::Response& res)
{
