...
namespace person_following_control {
    ...
    class HSRbPersonFollowing : public nodelet::Nodelet {
        private:
            ros::NodeHandle nh_;
            ros::NodeHandle pnh_;
            ...
            // multiple_sensor_person_tracking::FollowingPositionConstPtr following_position_msg;
            ...
            // void follow_pos_callback (
            //     const multiple_sensor_person_tracking::FollowingPositionConstPtr &msg
            // );
...
void person_following_control::HSRbPersonFollowing::callbackDynamicReconfigure(person_following_control::PersonFollowingParameterConfig& config, uint32_t level) {
...
void person_following_control::HSRbPersonFollowing::callbackData (
    const multiple_sensor_person_tracking::FollowingPositionConstPtr &following_position_msg) {
    //std::cout << "\n====================================" << std::endl;
...
void person_following_control::HSRbPersonFollowing::virtualSpringModelDynamicWindowApproach(
    const multiple_sensor_person_tracking::FollowingPositionConstPtr &following_position_msg,
    const nav_msgs::OdometryConstPtr &odom_msg,
    geometry_msgs::TwistPtr output_path)
{
...
void person_following_control::HSRbPersonFollowing::virtualSpringModel (
    const multiple_sensor_person_tracking::FollowingPositionConstPtr &following_position_msg,
    const nav_msgs::OdometryConstPtr &odom_msg,
    geometry_msgs::TwistPtr output_path)
{
...
void person_following_control::HSRbPersonFollowing::dynamicWindowApproach (
    const multiple_sensor_person_tracking::FollowingPositionConstPtr &following_position_msg,
    const nav_msgs::OdometryConstPtr &odom_msg,
    geometry_msgs::TwistPtr output_path)
{
...
void person_following_control::HSRbPersonFollowing::rotatePID (
    const multiple_sensor_person_tracking::FollowingPositionConstPtr &following_position_msg,
    const nav_msgs::OdometryConstPtr &odom_msg,
    geometry_msgs::TwistPtr output_path)
{
...
void person_following_control::HSRbPersonFollowing::odom_callback (const nav_msgs::OdometryConstPtr &msg)
{
    odom_msg = msg;
}

// void person_following_control::HSRbPersonFollowing::follow_pos_callback (const multiple_sensor_person_tracking::FollowingPositionConstPtr &msg)
// {
//     following_position_msg = msg;
// }

void person_following_control::HSRbPersonFollowing::obstacles_callback (const sensor_msgs::PointCloud2ConstPtr &obstacles_msg)
{
    obstacles_msg_ = obstacles_msg;
}

void person_following_control::HSRbPersonFollowing::onInit() {
    nh_ = getNodeHandle();
    ...
    odom_msg.reset( new nav_msgs::Odometry );
    // following_position_msg.reset( new multiple_sensor_person_tracking::FollowingPosition );

    pub_vel_ = nh_.advertise< geometry_msgs::Twist >( "cmd_vel", 1 );
    sub_obstacles_ = nh_.subscribe(pnh_.param<std::string>( "obstacles_topic_name", "/obstacles"), 1, &HSRbPersonFollowing::obstacles_callback, this);
    ...
    // sync_->registerCallback ( boost::bind( &HSRbPersonFollowing::callbackData, this, _1, _2 ) );
    sub_following_position_ = nh_.subscribe(pnh_.param<std::string>( "following_position_topic_name", "/following_position" ), 1, &HSRbPersonFollowing::callbackData, this);
    sub_odom_ = nh_.subscribe(pnh_.param<std::string>( "odom_topic_name", "/odom"), 1, &HSRbPersonFollowing::odom_callback, this);
    ...
    f_ = boost::bind(&HSRbPersonFollowing::callbackDynamicReconfigure, this, _1, _2);
    server_->setCallback(f_);
    use_pid_ = false;
    pre_time_ = ros::Time::now().toSec();
}

PLUGINLIB_EXPORT_CLASS(person_following_control::HSRbPersonFollowing, nodelet::Nodelet);