...
# map_target_x = 0.91*target_x - 0.40*target_y 
# map_target_y = 0.40*target_x+0.91*target_y
# map_robot_x = 0.91*robot_x - 0.40*robot_y
# map_robot_y = 0.40*robot_x+0.91*robot_y
map_target_x = target_x 
map_target_y = target_y + 0.575
map_robot_x = robot_x
map_robot_y = robot_y + 0.575
...
ax.set_aspect('equal', adjustable='box') # スケールを揃える
ax.grid()            # 罫線
ax.plot(map_target_x, map_target_y, color="deepskyblue", linestyle='-', linewidth=5, label="Person")
ax.plot(map_robot_x, map_robot_y, color="coral", linestyle='--', linewidth=5, label="Robot")
# obstacle
...
# 各要素の設定をおこなうsetコマンド
ax.set_xticklabels([0.0, 0.85, 1.3, 1.75, 2.4, 3.3, 3.75, 4.75, 5.75],fontsize=20)
ax.set_yticklabels([0.0, 0.575, 0.9, 1.15, 1.15, 1.4, 1.725, 2.3],fontsize=20)
