...
namespace multiple_sensor_person_tracking {
    ...
    class HSRbPersonTracker : public nodelet::Nodelet {
        private:
            ros::NodeHandle nh_;
            ros::NodeHandle pnh_;
...
visualization_msgs::Marker multiple_sensor_person_tracking::HSRbPersonTracker::makeLegPoseMarker( const std::vector<geometry_msgs::Pose>& leg_poses ) {
...
visualization_msgs::Marker multiple_sensor_person_tracking::HSRbPersonTracker::makeLegAreaMarker( const std::vector<geometry_msgs::Pose>& leg_poses ) {
    visualization_msgs::Marker leg_marker;
...
visualization_msgs::Marker multiple_sensor_person_tracking::HSRbPersonTracker::makeBodyPoseMarker( const std::vector<sobits_msgs::ObjectPose>& body_poses ) {
...
visualization_msgs::Marker multiple_sensor_person_tracking::HSRbPersonTracker::makeTargetPoseMarker( const Eigen::Vector4f& target_pose ) {
...
void multiple_sensor_person_tracking::HSRbPersonTracker::callbackDynamicReconfigure( multiple_sensor_person_tracking::TrackerParameterConfig& config, uint32_t level) {
...
bool multiple_sensor_person_tracking::HSRbPersonTracker::searchObstacles( const geometry_msgs::Point& search_pt,  const PointCloud::Ptr input_cloud, sensor_msgs::PointCloud2* obstacles ) {
...
geometry_msgs::PointStamped multiple_sensor_person_tracking::HSRbPersonTracker::transformPoint (
    const std::string& org_frame,
    const std::string& target_frame,
    const geometry_msgs::Point& point)
{
...
void multiple_sensor_person_tracking::HSRbPersonTracker::scan_callback (const sensor_msgs::LaserScanConstPtr &scan_msg)
{
    scan_msg_ = scan_msg;
}

void multiple_sensor_person_tracking::HSRbPersonTracker::nontravelableRegionCallback(const sensor_msgs::PointCloud2ConstPtr& nontravelable_region_msg)
{
...
void multiple_sensor_person_tracking::HSRbPersonTracker::callbackPoseArray ( const geometry_msgs::PoseArrayConstPtr &dr_spaam_msg, const sobits_msgs::ObjectPoseArrayConstPtr &ssd_msg ) {
    std::cout << "\n====================================" << std::endl;
...
void multiple_sensor_person_tracking::HSRbPersonTracker::onInit() {
    ...
    sub_scan_ = nh_.subscribe(pnh_.param<std::string>( "scan_topic_name", "/scan"), 1, &HSRbPersonTracker::scan_callback, this);
    sub_nontravelable_region_ = nh_.subscribe("/pointcloud_nontravelable_region", 1, &HSRbPersonTracker::nontravelableRegionCallback, this);
    ...
    sync_ ->registerCallback ( boost::bind( &HSRbPersonTracker::callbackPoseArray, this, _1, _2 ) );
...
PLUGINLIB_EXPORT_CLASS( multiple_sensor_person_tracking::HSRbPersonTracker, nodelet::Nodelet );