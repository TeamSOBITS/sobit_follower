...
namespace multiple_sensor_person_tracking {
    class SobitEduPersonAimSensorRotator : public nodelet::Nodelet {
        private:
			ros::NodeHandle nh_;
			ros::NodeHandle pnh_;
...
void multiple_sensor_person_tracking::SobitEduPersonAimSensorRotator::makeMarker( const double pan_angle, const double tilt_angle, const double distance ) {
...
void multiple_sensor_person_tracking::SobitEduPersonAimSensorRotator::callbackData (
    const multiple_sensor_person_tracking::FollowingPositionConstPtr &following_position_msg
    /*const nav_msgs::OdometryConstPtr &odom_msg*/) {
...
void multiple_sensor_person_tracking::SobitEduPersonAimSensorRotator::onInit() {
    ...
    f_ = boost::bind(&multiple_sensor_person_tracking::SobitEduPersonAimSensorRotator::callbackDynamicReconfigure, this, _1, _2);
    ...
    // sync_->registerCallback ( boost::bind( &SobitEduPersonAimSensorRotator::callbackData, this, _1, _2 ) );

    sub_following_position_ = nh_.subscribe(pnh_.param<std::string>( "following_position_topic_name", "/following_position" ), 1, &SobitEduPersonAimSensorRotator::callbackData, this);
...
PLUGINLIB_EXPORT_CLASS(multiple_sensor_person_tracking::SobitEduPersonAimSensorRotator, nodelet::Nodelet);
