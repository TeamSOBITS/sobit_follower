...
namespace multiple_sensor_person_tracking {
    ...
    class SobitProPersonTracker : public rclcpp::Node {
        private:
        ...
        public:
            explicit SobitProPersonTracker(const rclcpp::NodeOptions & options)
            : Node("sobit_pro_person_tracker", options),
...
visualization_msgs::msg::Marker multiple_sensor_person_tracking::SobitProPersonTracker::makeLegPoseMarker( const std::vector<geometry_msgs::msg::Pose>& leg_poses ) {
...
visualization_msgs::msg::Marker multiple_sensor_person_tracking::SobitProPersonTracker::makeLegAreaMarker( const std::vector<geometry_msgs::msg::Pose>& leg_poses ) {
    visualization_msgs::msg::Marker leg_marker;
...
visualization_msgs::msg::Marker multiple_sensor_person_tracking::SobitProPersonTracker::makeBodyPoseMarker( const std::vector<sobits_interfaces::msg::ObjectPose>& body_poses ) {
...
visualization_msgs::msg::Marker multiple_sensor_person_tracking::SobitProPersonTracker::makeTargetPoseMarker( const Eigen::Vector4f& target_pose ) {
...
bool multiple_sensor_person_tracking::SobitProPersonTracker::searchObstacles( const geometry_msgs::msg::Point& search_pt,  const PointCloud::Ptr input_cloud, sensor_msgs::msg::PointCloud2* obstacles ) {
...
geometry_msgs::msg::PointStamped multiple_sensor_person_tracking::SobitProPersonTracker::transformPoint (
    const std::string& org_frame,
    const std::string& target_frame,
    const geometry_msgs::msg::Point& point)
{
...
void multiple_sensor_person_tracking::SobitProPersonTracker::scan_callback (const sensor_msgs::msg::LaserScan::ConstSharedPtr &scan_msg)
{
    scan_msg_ = scan_msg;
}

void multiple_sensor_person_tracking::SobitProPersonTracker::nontravelableRegionCallback(const sensor_msgs::msg::PointCloud2::ConstSharedPtr& nontravelable_region_msg)
{
...
void multiple_sensor_person_tracking::SobitProPersonTracker::callbackPoseArray ( const geometry_msgs::msg::PoseArray::ConstSharedPtr dr_spaam_msg, const sobits_interfaces::msg::ObjectPoseArray::ConstSharedPtr ssd_msg ) {
    std::cout << "\n====================================" << std::endl;
...
void multiple_sensor_person_tracking::SobitProPersonTracker::onInit() {
    ...
    sub_scan_ = create_subscription<sensor_msgs::msg::LaserScan>(
        scan_topic_name, 1, std::bind(&SobitProPersonTracker::scan_callback, this, std::placeholders::_1));

    sub_nontravelable_region_ = create_subscription<sensor_msgs::msg::PointCloud2>(
        pointcloud_nontravelable_region_topic_name, 1, std::bind(&SobitProPersonTracker::nontravelableRegionCallback, this, std::placeholders::_1));
    ...
    sync_ ->registerCallback ( &SobitProPersonTracker::callbackPoseArray, this );
...
RCLCPP_COMPONENTS_REGISTER_NODE(multiple_sensor_person_tracking::SobitProPersonTracker)