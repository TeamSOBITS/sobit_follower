...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitProPersonTracker::makeBodyPoseMarker( const std::vector<sobits_msgs_msg::ObjectPose>& body_poses ) {
...
bool start = true;
void multiple_sensor_person_tracking::SobitProPersonTracker::callbackPoseArray ( const multiple_sensor_person_tracking::LegPoseArrayConstPtr &dr_spaam_msg, const sobits_msgs_msg::ObjectPoseArrayConstPtr &ssd_msg ) {
    std::cout << "\n====================================" << std::endl;
    // if (start) {
