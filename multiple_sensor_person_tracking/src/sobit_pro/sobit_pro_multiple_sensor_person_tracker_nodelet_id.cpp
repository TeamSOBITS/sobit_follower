...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitProPersonTrackerId::makeBodyPoseMarker( const std::vector<sobit_common_msg::ObjectPose>& body_poses ) {
