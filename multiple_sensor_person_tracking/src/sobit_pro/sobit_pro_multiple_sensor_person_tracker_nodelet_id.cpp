...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitProPersonTrackerId::makeBodyPoseMarker( const std::vector<sobits_msgs::ObjectPose>& body_poses ) {
