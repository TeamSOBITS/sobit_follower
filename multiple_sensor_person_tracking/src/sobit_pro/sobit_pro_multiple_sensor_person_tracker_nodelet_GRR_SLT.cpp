...
namespace multiple_sensor_person_tracking {
    ...
    class SobitProPersonTrackerGRRSLT : public nodelet::Nodelet {
        private:
            ros::NodeHandle nh_;
            ros::NodeHandle pnh_;
...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::makeLegPoseMarker( const std::vector<geometry_msgs::Pose>& leg_poses ) {
...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::makeLegAreaMarker( const std::vector<geometry_msgs::Pose>& leg_poses ) {
    visualization_msgs::Marker leg_marker;
...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::makeBodyPoseMarker( const std::vector<sobits_msgs::ObjectPose>& body_poses ) {
...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::makeTargetPoseMarker( const Eigen::Vector4f& target_pose ) {
...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::makeNoExistsTargetPoseMarker( const geometry_msgs::Pose& no_target_pose ) {
...
void multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::callbackDynamicReconfigure( multiple_sensor_person_tracking::TrackerParameterConfig& config, uint32_t level) {
...
// int multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::findTwoObservationValue(
//     const std::vector<geometry_msgs::Pose>& leg_poses,
//     const std::vector<sobits_msgs::ObjectPose>& body_poses,
//     Eigen::Vector2f* leg_observed_value,
//     Eigen::Vector2f* body_observed_value )
...
int multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::findThreeObservationValue(
    const std::vector<geometry_msgs::Pose>& leg_poses,
    const std::vector<double>& position,  // id_msg->position
    int target_id,
    Eigen::Vector2f* leg_observed_value,
...
void multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::searchObstacles( const geometry_msgs::Point& search_pt,  const PointCloud::Ptr input_cloud, sensor_msgs::PointCloud2* obstacles ) {
...
geometry_msgs::PointStamped multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::transformPoint (
    const std::string& org_frame,
    const std::string& target_frame,
    const geometry_msgs::Point& point)
{
...
void multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::scan_callback (const sensor_msgs::LaserScanConstPtr &scan_msg)
{
    scan_msg_ = scan_msg;
}

// bool start_id = false;
void multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::callbackPoseArray ( const geometry_msgs::PoseArrayConstPtr &dr_spaam_msg, const sobits_msgs::ObjectPoseArrayConstPtr &yolo_msg, const mono_following::TargetConstPtr &id_msg ) {
    std::cout << "\n====================================" << std::endl;
    // if (start_id) {
...
void multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::onInit() {
    nh_ = getNodeHandle();
    ...
    sub_scan_ = nh_.subscribe(pnh_.param<std::string>( "scan_topic_name", "/scan"), 1, &SobitProPersonTrackerGRRSLT::scan_callback, this);
    ...
    sync_ ->registerCallback ( boost::bind( &SobitProPersonTrackerGRRSLT::callbackPoseArray, this, _1, _2, _3 ) );
    ...
    f_ = boost::bind(&multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT::callbackDynamicReconfigure, this, _1, _2);
...
PLUGINLIB_EXPORT_CLASS( multiple_sensor_person_tracking::SobitProPersonTrackerGRRSLT, nodelet::Nodelet );