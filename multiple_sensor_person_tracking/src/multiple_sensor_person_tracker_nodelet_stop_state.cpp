...
namespace multiple_sensor_person_tracking {
    ...
    class PersonTrackerStopState : public nodelet::Nodelet {
        private:
            ros::NodeHandle nh_;
            ros::NodeHandle pnh_;
...
visualization_msgs::Marker multiple_sensor_person_tracking::PersonTrackerStopState::makeLegPoseMarker( const std::vector<geometry_msgs::Pose>& leg_poses ) {
...
visualization_msgs::Marker multiple_sensor_person_tracking::PersonTrackerStopState::makeLegAreaMarker( const std::vector<geometry_msgs::Pose>& leg_poses ) {
    visualization_msgs::Marker leg_marker;
...
visualization_msgs::Marker multiple_sensor_person_tracking::PersonTrackerStopState::makeBodyPoseMarker( const std::vector<sobit_common_msg::ObjectPose>& body_poses ) {
...
visualization_msgs::Marker multiple_sensor_person_tracking::PersonTrackerStopState::makeTargetPoseMarker( const Eigen::Vector4f& target_pose ) {
...
//FIXME:むっちょ
// visualization_msgs::Marker multiple_sensor_person_tracking::PersonTrackerStopState::makeTargetPoseMarker_LastPosition( const geometry_msgs::PointStamped& target_pose ) {
//     visualization_msgs::Marker target_marker;
//     target_marker.header.frame_id = target_frame_;
//     target_marker.header.stamp = ros::Time::now();
//     target_marker.ns = "target_marker";
...
visualization_msgs::Marker multiple_sensor_person_tracking::PersonTrackerStopState::makeNoExistsTargetPoseMarker( const geometry_msgs::Pose& no_target_pose ) {
...
void multiple_sensor_person_tracking::PersonTrackerStopState::callbackDynamicReconfigure( multiple_sensor_person_tracking::TrackerParameterConfig& config, uint32_t level) {
...
int multiple_sensor_person_tracking::PersonTrackerStopState::findTwoObservationValue(
    const std::vector<geometry_msgs::Pose>& leg_poses,
    const std::vector<sobit_common_msg::ObjectPose>& body_poses,
    Eigen::Vector2f* leg_observed_value,
    Eigen::Vector2f* body_observed_value )
...
int multiple_sensor_person_tracking::PersonTrackerStopState::findThreeObservationValue(
    const std::vector<geometry_msgs::Pose>& leg_poses,
    const std::vector<sobit_common_msg::ObjectPose>& body_poses,
    int target_id,
    Eigen::Vector2f* leg_observed_value,
...
void multiple_sensor_person_tracking::PersonTrackerStopState::searchObstacles( const geometry_msgs::Point& search_pt,  const PointCloud::Ptr input_cloud, sensor_msgs::PointCloud2* obstacles ) {
...
geometry_msgs::PointStamped multiple_sensor_person_tracking::PersonTrackerStopState::transformPoint (
    const std::string& org_frame,
    const std::string& target_frame,
    const geometry_msgs::Point& point)
{
...
void multiple_sensor_person_tracking::PersonTrackerStopState::callbackPoseArray ( const multiple_sensor_person_tracking::LegPoseArrayConstPtr &dr_spaam_msg, const sobit_common_msg::ObjectPoseArrayConstPtr &ssd_msg, const person_id_follow_nodelet::SOBITTargetConstPtr &id_msg ) {
    std::cout << "\n====================================" << std::endl;
...
void multiple_sensor_person_tracking::PersonTrackerStopState::onInit() {
    nh_ = getNodeHandle();
    ...
    sync_ ->registerCallback ( boost::bind( &PersonTrackerStopState::callbackPoseArray, this, _1, _2, _3 ) );
    ...
    f_ = boost::bind(&multiple_sensor_person_tracking::PersonTrackerStopState::callbackDynamicReconfigure, this, _1, _2);
...
PLUGINLIB_EXPORT_CLASS( multiple_sensor_person_tracking::PersonTrackerStopState, nodelet::Nodelet );