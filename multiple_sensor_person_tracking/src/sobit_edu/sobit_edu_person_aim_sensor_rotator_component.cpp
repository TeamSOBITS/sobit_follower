...
namespace multiple_sensor_person_tracking {
    class SobitEduPersonAimSensorRotator : public rclcpp::Node {
        private:
        ...
        public:
            explicit SobitEduPersonAimSensorRotator(const rclcpp::NodeOptions & options)
            : rclcpp::Node("sobit_edu_person_aim_sensor_rotator", options),
