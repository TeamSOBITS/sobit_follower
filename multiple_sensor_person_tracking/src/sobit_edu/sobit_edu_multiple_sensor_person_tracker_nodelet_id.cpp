...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitEduPersonTrackerId::makeBodyPoseMarker( const std::vector<sobits_msgs::ObjectPose>& body_poses ) {
