...
visualization_msgs::Marker multiple_sensor_person_tracking::SobitEduPersonTrackerId::makeBodyPoseMarker( const std::vector<sobits_msgs_msg::ObjectPose>& body_poses ) {
...
void multiple_sensor_person_tracking::SobitEduPersonTrackerId::callbackPoseArray ( const multiple_sensor_person_tracking::LegPoseArrayConstPtr &dr_spaam_msg, const sobits_msgs_msg::ObjectPoseArrayConstPtr &ssd_msg, const person_id_follow_nodelet::SOBITTargetConstPtr &id_msg ) {
    std::cout << "\n====================================" << std::endl;
