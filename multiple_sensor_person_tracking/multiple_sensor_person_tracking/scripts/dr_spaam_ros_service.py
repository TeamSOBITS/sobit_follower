...
class DrSpaamROS:
    ...
    def _init(self):
        ...
        """
        # Publisher
        topic, queue_size, latch = self._read_publisher_param("detections")
        self._dets_pub = rospy.Publisher(topic, PoseArray, queue_size=queue_size, latch=latch)
        topic, queue_size, latch = self._read_publisher_param("rviz")
        self._rviz_pub = rospy.Publisher(topic, Marker, queue_size=queue_size, latch=latch)
        # server
    ...
    def _scan_callback(self, req):
        ...
        # rviz_msg.header = req.scan.header
