...
{     
    ...
    rotate_pos.process_flag = SVDD_LEG_DETECTION;
    rotate_pos.target_distance = svdd_person.distance_;
    rotate_pos.target_angle = svdd_person.angle_;
...
int SVDDParticlePersonTracker::predictPersonPositionSVDD ( const PointCloud::Ptr laser )
{
    ...
    person_tracking4::RotatePosition rotate_pos;
    rotate_pos.process_flag = SVDD_LEG_DETECTION;
    rotate_pos.target_distance = target_dist;
    rotate_pos.target_angle = target_ang;
    pub_sensor_rotator_.publish(rotate_pos);
    return PREDICTION;
}
    ...
    person_tracking4::FollowPositionPtr follow_position ) 
{
    ...
    person_tracking4::FollowPosition tmp_fp;
