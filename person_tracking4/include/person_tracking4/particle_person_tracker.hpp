...
#include <person_tracking4/person_aim_sensor_rotator.hpp>
...
namespace person_tracking4 {
    class ParticlePersonTracker {
        protected :
            ...
            ros::Publisher pub_sensor_rotator_;

            person_tracking4::PCLHandle pch_;
            point_cloud_tracker::PointCloudTracker pct_;
            person_tracking4::FollowPositionHandle fph_;
        ...
        public :
            ...
            int findPersonsPosition( const sobit_common_msg::ObjectPoseArrayConstPtr object_pose_array, std::vector<geometry_msgs::Point>* person_pts );
            int computeParticle(    
